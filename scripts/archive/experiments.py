...
def initial_downsample_comparison():
    ...
    # fig1.savefig('res/downsample_tests/sliced_data.eps', bbox_inches=extent2)
    # extent3 = ax3.get_window_extent().transformed(fig1.dpi_scale_trans.inverted())
    # fig1.savefig('res/downsample_tests/mean_data.eps', bbox_inches=extent3)
    
    # plt.show()
    
    # comp_img1 = imread('res/downsample_tests/sliced_data.eps')
    # comp_img2 = imread('res/downsample_tests/mean_data.eps')
